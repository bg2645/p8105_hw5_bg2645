...
* Based on the two overlayed graphs in the figure above, it can be see that the sample average of beta1_hat across tests for which the null is rejected is not equal to the true value of beta1. This is because there is a large difference when the true value of beta 1 is small, as the true value of beta1 increases the difference between the two tests becomes smaller. 
